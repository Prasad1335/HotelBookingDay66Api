...
namespace HotelBookingDay66Api.Controllers
{
    ...
    public class HotelRoomsController : ControllerBase
    {
        ...
        public HotelRoomsController(HotelBookingContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<HotelRoom>> PostHotelRoom(HotelRoom hotelRoom)
        {
          if (_context.HotelRooms == null)
          {
              return Problem("Entity set 'HotelBookingContext.HotelRooms'  is null.");
          }
        ...
        {
            return (_context.HotelRooms?.Any(e => e.RoomId == id)).GetValueOrDefault();
        }
    }
}
