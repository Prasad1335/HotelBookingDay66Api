...
namespace HotelBookingDay66Api.Controllers
{
    ...
    public class HotelBookingsController : ControllerBase
    {
        ...
        public HotelBookingsController(HotelBookingContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<HotelBooking>> PostHotelBooking(HotelBooking hotelBooking)
        {
          if (_context.HotelBookings == null)
          {
              return Problem("Entity set 'HotelBookingContext.HotelBookings'  is null.");
          }
            _context.HotelBookings.Add(hotelBooking);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetHotelBooking", new { id = hotelBooking.HotelId }, hotelBooking);
        }
        ...
        {
            return (_context.HotelBookings?.Any(e => e.HotelId == id)).GetValueOrDefault();
        }
    }
}
